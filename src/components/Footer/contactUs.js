    		...
    		<Card style={{backgroundColor:'rgb(47,50,59)', border:'1px solid grey'}}>
    			<Form className="formStyle" onSubmit={this.onClick}>
    				<InputGroup className="form-group row justify-content-center" style={{paddingTop:'0.5rem'}}>
    		 			<InputGroup.Prepend htmlFor="name" className="col-3 col-sm-3" style={{backgroundColor:'rgb(47,50,59)', fontSize:'0.75rem', paddingLeft:'0px'}} >姓名</InputGroup.Prepend>
    		 			<FormControl onChange={this.onChange} value={this.state.name} className="col-7 col-sm-6 form-control text-white" style={{backgroundColor:'rgb(47,50,59)', fontSize:'0.75rem', height:'1rem', border:'none',  borderBottom: '1px solid grey', borderRadius:'0',WebkitAppearance:'none',color:'white'}} id="name" name="name" placeholder="请输入姓名" required/>
    		 		</InputGroup>
    				<InputGroup className="form-group row justify-content-center">
    		 			<InputGroup.Prepend className="col-3 col-sm-3" htmlFor="phone" style={{backgroundColor:'rgb(47,50,59)', fontSize:'0.75rem', paddingLeft:'0px'}} >电话</InputGroup.Prepend>
    		 			<FormControl onChange={this.onChange} value={this.state.phone} className="col-7 col-sm-6 form-control text-white" style={{backgroundColor:'rgb(47,50,59)', fontSize:'0.75rem', height:'1rem', border:'none', borderBottom:'1px solid grey',borderRadius:'0',WebkitAppearance:'none',color:'white'}} id="phone" name="phone" placeholder="请输入电话" required/>
    		 		</InputGroup>
    				<InputGroup className="form-group row justify-content-center ">
    					<InputGroup.Prepend className="col-3 col-sm-3" htmlFor="note" style={{backgroundColor:'rgb(47,50,59)', fontSize:'0.75rem', paddingLeft:'0px'}} >留言</InputGroup.Prepend>
